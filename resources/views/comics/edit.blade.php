    ...
    <div class="col py-4">
        ...
        <form action="{{ route('comics.update', ['comic' => $comic->id]) }}" method="POST"> 
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" @error('description') is-invalid @enderror id="description" name="description" rows="3" maxlength="4000" placeholder="Add your updated Comic Description...">{{ old('description', $comic->description) }}</textarea>
                @error('description')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
